...
struct Data{
    ...
    static var dataBlobOne = [KanjiData(kanji:"安",kunyomi:"yasu(i)", onyomi:"AN", translations: ["peace","cheap","safety"],similarKanji:nil, parts:nil),
        ...
        KanjiData(kanji:"飲",kunyomi:"no(mu)", onyomi:"IN", translations: ["to drink"],similarKanji:nil, parts:["食"]),
        KanjiData(kanji:"右",kunyomi:"migi", onyomi:"U, YUU", translations: ["right"],similarKanji:["左"], parts:nil),
        ...
        KanjiData(kanji:"会",kunyomi:"a(u)", onyomi:"KAI, E", translations: ["to meet","to come together","society"],similarKanji:["今"], parts:nil),
        ...
        KanjiData(kanji:"月",kunyomi:"tsuki", onyomi:"GETSU, GATSU", translations: ["month","moon"],similarKanji:["見"], parts:nil),
        ...
        KanjiData(kanji:"口",kunyomi:"kuchi", onyomi:"KOU, KU", translations: ["mouth"],similarKanji:["四"], parts:nil),
        ...
        KanjiData(kanji:"左",kunyomi:"hidari", onyomi:"SA", translations: ["left"],similarKanji:["右"], parts:nil),
        ...
        KanjiData(kanji:"四",kunyomi:"yo(ttsu), yu(tsu), yo-, yon-", onyomi:"SHI", translations: ["four"],similarKanji:["口"], parts:nil),
        ...
        KanjiData(kanji:"七",kunyomi:"nana(tsu), nana-, nano-", onyomi:"SHICHI", translations: ["seven"],similarKanji:["土"], parts:nil),
        ...
        KanjiData(kanji:"十",kunyomi:"too, to-", onyomi:"JUU, JI", translations: ["ten","cross"],similarKanji:["土"], parts:nil),
        ...
        KanjiData(kanji:"上",kunyomi:"ue, kami, a(geru), a(garu)", onyomi:"SHOU, JOU", translations: ["above","upper"],similarKanji:["土"], parts:nil),
        ...
        KanjiData(kanji:"日",kunyomi:"hi, -ka", onyomi:"NICHI, JITSU", translations: ["day","sun"],similarKanji:["目", "見"], parts:nil),
        ...
        KanjiData(kanji:"白",kunyomi:"shiro(i), shiro", onyomi:"HAKU, BYAKU", translations: ["white"],similarKanji:["耳", "目"], parts:nil),
        ...
        KanjiData(kanji:"父",kunyomi:"chichi", onyomi:"FU", translations: ["father"],similarKanji:["分"], parts:nil),
        KanjiData(kanji:"分",kunyomi:"wa(keru), wa(kareru), wa(karu)", onyomi:"BUN, BU, FUN", translations: ["part","minute","to divide","to understand"],similarKanji:["父"], parts:nil),
        ...
        KanjiData(kanji:"目",kunyomi:"me", onyomi:"MOKU", translations: ["eye"],similarKanji:["耳", "見"], parts:nil),
        ...
        KanjiData(kanji:"立",kunyomi:"ta(tsu), ta(teru)", onyomi:"RITSU", translations: ["to stand","to establish"],similarKanji:["六"], parts:nil),
        KanjiData(kanji:"六",kunyomi:"mutt(su), mu(tsu), mu, mui", onyomi:"ROKU", translations: ["six"],similarKanji:["立"], parts:nil),
